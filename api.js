...
const signin = async (data) => {
  try {
    const res = (await api.post(`${config.backend_url}/api/auth/login`, data))
      .data;
    if (res.success) {
...
export const updateQuantity = async (data) => {
  ...
  try {
    const res = (
      await api.post(`${config.backend_url}/api/product/update_quantity`, data)
    ).data;
...
export const getProduct = async (data, router) => {
  ...
  try {
    const res = (
      await api.post(`${config.backend_url}/api/product/get_product`, data)
    ).data;
...
export const getSummary = async (data) => {
  ...
  try {
    const res = (
      await api.post(`${config.backend_url}/api/product/get_summary`, data)
    ).data;
    return res;
  } catch (err) {
    return { success: false, message: "Server Error" };
...
export const customizeDeploy = async (data) => {
  ...
  try {
    const res = (
      await api.post(`${config.backend_url}/api/product/customize_deploy`, data)
    ).data;
...
export const surveyDeploy = async (data) => {
  ...
  try {
    const res = (
      await api.post(`${config.backend_url}/api/product/survey_deploy`, data)
    ).data;
...
export const forgotPassword = async (data) => {
  ...
  try {
    const res = (
      await api.post(`${config.backend_url}/api/auth/forgot_password`, data)
    ).data;
...
export const createPayment = async (data) => {
  ...
  try {
    const res = (
      await api.post(`${config.backend_url}/api/payment/create_payment`, data)
    ).data;
    return res;
  } catch (err) {
    return { success: false, message: "Server Error" };
...
export const updateWaxAccount = async (data) => {
    try {
      const res = await api.post(
        `${config.backend_url}/api/auth/wax`,
        data
      );
      return res.data;
    } catch (err) {
...
export const getUser = async (data) => {
  try {
    const res = await api.get(
      `${config.backend_url}/api/auth/info`,
      data
    );
    return res.data;
  } catch (err) {
